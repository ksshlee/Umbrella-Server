...
from .key_features.url_look_up import v1_url_look_up
from .key_features.valid_url import v1_valid
from django.http import JsonResponse

# Create your views here.
@csrf_exempt
def v1_valid_url(request):
    if request.method == 'POST':
        ...
        results = v1_url_look_up(url) # url whois 로 조회 결과 results 에 담기
